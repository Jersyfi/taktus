...
is green in one command. `make doctor` says which of the two levels is present; Node and Docker are listed
as optional, for the web and database targets that need them. CI reaches the same preflight through
